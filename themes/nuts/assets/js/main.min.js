(function () {
    ...
    const swiperEastPacking = () => {
      let swiperEastPacking = new Swiper('.catalog__container-east', {
        ...
        breakpoints: {
          ...
          1200: {
            slidesPerView: 3 // allowTouchMove: false,
      ...
      var smoothScroll = function (eID) {
        ...
        if (stopY > startY) {
          for (var i = startY; i < stopY; i += step) {
            ...
            timer++; // var panel = document.querySelector( "#my-menu" );
    ...
    const salAnimation = () => {
      window.sal(); //Проверка в DOMe на наличие классов
      ...
      if (document.querySelector('.sal-slider-kernel--js')) {
        ...
        swiperProductsPackingKernel.addEventListener('sal:in', ({
          detail
        }) => {
      ...
      if (document.querySelector('.sal-slider-east--js')) {
        ...
        swiperEastPacking.addEventListener('sal:in', ({
          detail
        }) => {
      ...
      if (document.querySelector('.sal-slider-shell--js')) {
        ...
        swiperShell.addEventListener('sal:in', ({
          detail
        }) => {
      ...
      if (document.querySelector('.sal-slider-jmikh--js')) {
        ...
        swiperJmikh.addEventListener('sal:in', ({
          detail
        }) => {
      ...
      if (document.querySelector('.sal-slider-oil--js')) {
        ...
        swiperOil.addEventListener('sal:in', ({
          detail
        }) => {
      ...
      if (document.querySelector('.sal-slider-membrane--js')) {
        ...
        swiperMembrane.addEventListener('sal:in', ({
          detail
        }) => {
      ...
      if (document.querySelector('.sal-slider-crushed--js')) {
        ...
        swiperCrushed.addEventListener('sal:in', ({
          detail
        }) => {
    ...
    const preloader = () => {
      var animationDuration = 2500; // var animationDuration = 1;
